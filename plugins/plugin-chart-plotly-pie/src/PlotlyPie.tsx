...
import { PlotlyPieProps, PlotlyPieStylesProps } from './types';
...
const Styles = styled.div<PlotlyPieStylesProps>`
...
export default class PlotlyPie extends PureComponent<PlotlyPieProps> {
